...
Funktionen:
  ...
  • VISA-Adresse manuell eingeben (SMU und MUX, Standardwerte vorausgefüllt)
...
class LangmuirGUI(tk.Tk):
    ...
    def _tab_smu_verbindung(self, nb: ttk.Notebook) -> None:
        ...
        self._smu_adresse_var = tk.StringVar(value="USB0::10893::37633::MY61390350::0::INSTR")
        self._smu_adresse_entry = ttk.Entry(
            zeile, textvariable=self._smu_adresse_var, state="disabled", width=46)
        self._smu_adresse_entry.pack(side=tk.LEFT, fill=tk.X, expand=True)
        _tooltip(self._smu_adresse_entry,
                 "VISA-Ressourcen-String des SMU.\n"
                 "Standardwert: USB0::10893::37633::MY61390350::0::INSTR")
    ...
    def _tab_mux(self, nb: ttk.Notebook) -> None:
        ...
        self._mux_adresse_var = tk.StringVar(value="USB0::2391::1287::MY65320033::0::INSTR")
        self._mux_adresse_entry = ttk.Entry(
            zeile_addr, textvariable=self._mux_adresse_var, state="disabled", width=46)
        self._mux_adresse_entry.pack(side=tk.LEFT, fill=tk.X, expand=True)
        _tooltip(self._mux_adresse_entry,
                 "VISA-Adresse des 34923A Multiplexers.\n"
                 "Standardwert: USB0::2391::1287::MY65320033::0::INSTR")
    ...
    def _simulation_umschalten(self) -> None:
        """Aktiviert/deaktiviert VISA-Adressfeld je nach Simulationsmodus."""
        simulation = self._simulation_var.get()
        self._smu_adresse_entry.configure(state="disabled" if simulation else "normal")
    ...
    def _mux_aktiv_umschalten(self) -> None:
        ...
        # Adressfeld
        self._mux_adresse_entry.configure(state="normal" if aktiv else "disabled")
